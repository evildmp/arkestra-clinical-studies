...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trial.ukcrn'
        db.add_column('arkestra_clinical_trials_trial', 'ukcrn',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Trial.eudract'
        db.add_column('arkestra_clinical_trials_trial', 'eudract',
                      self.gf('django.db.models.fields.CharField')(max_length=18, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trial.ukcrn'
        db.delete_column('arkestra_clinical_trials_trial', 'ukcrn')

        # Deleting field 'Trial.eudract'
        db.delete_column('arkestra_clinical_trials_trial', 'eudract')
