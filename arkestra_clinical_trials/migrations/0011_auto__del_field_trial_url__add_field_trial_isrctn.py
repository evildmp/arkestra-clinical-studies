...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('arkestra_clinical_trials_trial', 'url')

        # Adding field 'Trial.isrctn'
        db.add_column('arkestra_clinical_trials_trial', 'isrctn',
    ...
    def backwards(self, orm):
        ...
        db.add_column('arkestra_clinical_trials_trial', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Trial.isrctn'
        db.delete_column('arkestra_clinical_trials_trial', 'isrctn')
