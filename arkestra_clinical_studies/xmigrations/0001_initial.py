...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('arkestra_clinical_trials_clinicaltrial', (
            ...
            ('external_url', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='clinicaltrial_item', null=True, on_delete=models.PROTECT, to=orm['links.ExternalLink'])),
