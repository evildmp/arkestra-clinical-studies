...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trial.email'
        db.add_column('arkestra_clinical_trials_trial', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trial.email'
        db.delete_column('arkestra_clinical_trials_trial', 'email')
