...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TrialEntity.clinical_trials_page_intro'
        db.delete_column('arkestra_clinical_trials_trialentity', 'clinical_trials_page_intro_id')

        # Adding field 'TrialEntity.trials_page_intro'
        db.add_column('arkestra_clinical_trials_trialentity', 'trials_page_intro',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='trials_page_intro', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)


        # Changing field 'TrialType.name'
        db.alter_column('arkestra_clinical_trials_trialtype', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Adding field 'TrialEntity.clinical_trials_page_intro'
        db.add_column('arkestra_clinical_trials_trialentity', 'clinical_trials_page_intro',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='clinical_trials_page_intro', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)

        # Deleting field 'TrialEntity.trials_page_intro'
        db.delete_column('arkestra_clinical_trials_trialentity', 'trials_page_intro_id')


        # Changing field 'TrialType.name'
        db.alter_column('arkestra_clinical_trials_trialtype', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        'arkestra_clinical_trials.trial': {
            ...
            'trialtype': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['arkestra_clinical_trials.TrialType']", 'null': 'True', 'blank': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        'arkestra_clinical_trials.trialentity': {
            'Meta': {'object_name': 'TrialEntity'},
            'entity': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'trial_entity'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['contacts_and_people.Entity']"}),
            ...
            'trials_page_intro': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'trials_page_intro'", 'null': 'True', 'to': "orm['cms.Placeholder']"})
        },
