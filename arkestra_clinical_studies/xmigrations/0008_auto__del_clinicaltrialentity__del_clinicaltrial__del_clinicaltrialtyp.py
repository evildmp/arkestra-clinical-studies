...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ClinicalTrialEntity'
        db.delete_table('arkestra_clinical_trials_clinicaltrialentity')

        # Deleting model 'ClinicalTrial'
        db.delete_table('arkestra_clinical_trials_clinicaltrial')

        # Removing M2M table for field funding_body on 'ClinicalTrial'
        db.delete_table(db.shorten_name('arkestra_clinical_trials_clinicaltrial_funding_body'))

        # Removing M2M table for field sponsor on 'ClinicalTrial'
        db.delete_table(db.shorten_name('arkestra_clinical_trials_clinicaltrial_sponsor'))

        # Removing M2M table for field clinical_centre on 'ClinicalTrial'
        db.delete_table(db.shorten_name('arkestra_clinical_trials_clinicaltrial_clinical_centre'))
        ...
        # Removing M2M table for field chief_investigators on 'ClinicalTrial'
        db.delete_table(db.shorten_name('arkestra_clinical_trials_clinicaltrial_chief_investigators'))

        # Removing M2M table for field publish_to on 'ClinicalTrial'
        db.delete_table(db.shorten_name('arkestra_clinical_trials_clinicaltrial_publish_to'))

        # Removing M2M table for field please_contact on 'ClinicalTrial'
        db.delete_table(db.shorten_name('arkestra_clinical_trials_clinicaltrial_please_contact'))

        # Deleting model 'ClinicalTrialType'
        db.delete_table('arkestra_clinical_trials_clinicaltrialtype')

        # Adding model 'TrialEntity'
        db.create_table('arkestra_clinical_trials_trialentity', (
            ('entity', self.gf('django.db.models.fields.related.OneToOneField')(related_name='clinical_trial_entity', unique=True, primary_key=True, to=orm['contacts_and_people.Entity'])),
            ('publish_page', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('menu_title', self.gf('django.db.models.fields.CharField')(default='Clinical trials', max_length=50)),
            ('clinical_trials_page_intro', self.gf('django.db.models.fields.related.ForeignKey')(related_name='clinical_trials_page_intro', null=True, to=orm['cms.Placeholder'])),
        ))
        db.send_create_signal('arkestra_clinical_trials', ['TrialEntity'])

        # Adding model 'TrialType'
        db.create_table('arkestra_clinical_trials_trialtype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('arkestra_clinical_trials', ['TrialType'])

        # Adding model 'Trial'
        db.create_table('arkestra_clinical_trials_trial', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('external_url', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='trial_item', null=True, on_delete=models.PROTECT, to=orm['links.ExternalLink'])),
            ...
            ('hosted_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trial_hosted_events', on_delete=models.SET_DEFAULT, default=None, to=orm['contacts_and_people.Entity'], blank=True, null=True)),
        ...
        db.send_create_signal('arkestra_clinical_trials', ['Trial'])

        # Adding M2M table for field publish_to on 'Trial'
        m2m_table_name = db.shorten_name('arkestra_clinical_trials_trial_publish_to')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('trial', models.ForeignKey(orm['arkestra_clinical_trials.trial'], null=False)),
            ('entity', models.ForeignKey(orm['contacts_and_people.entity'], null=False))
        ))
        db.create_unique(m2m_table_name, ['trial_id', 'entity_id'])

        # Adding M2M table for field please_contact on 'Trial'
        m2m_table_name = db.shorten_name('arkestra_clinical_trials_trial_please_contact')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('trial', models.ForeignKey(orm['arkestra_clinical_trials.trial'], null=False)),
            ('person', models.ForeignKey(orm['contacts_and_people.person'], null=False))
        ))
        db.create_unique(m2m_table_name, ['trial_id', 'person_id'])

        # Adding M2M table for field trialtype on 'Trial'
        m2m_table_name = db.shorten_name('arkestra_clinical_trials_trial_trialtype')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('trial', models.ForeignKey(orm['arkestra_clinical_trials.trial'], null=False)),
            ('trialtype', models.ForeignKey(orm['arkestra_clinical_trials.trialtype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['trial_id', 'trialtype_id'])

        # Adding M2M table for field chief_investigators on 'Trial'
        m2m_table_name = db.shorten_name('arkestra_clinical_trials_trial_chief_investigators')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('trial', models.ForeignKey(orm['arkestra_clinical_trials.trial'], null=False)),
            ('person', models.ForeignKey(orm['contacts_and_people.person'], null=False))
        ...
        # Adding M2M table for field clinical_centre on 'Trial'
        m2m_table_name = db.shorten_name('arkestra_clinical_trials_trial_clinical_centre')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('trial', models.ForeignKey(orm['arkestra_clinical_trials.trial'], null=False)),
            ('entity', models.ForeignKey(orm['contacts_and_people.entity'], null=False))
        ...
        # Adding M2M table for field funding_body on 'Trial'
        m2m_table_name = db.shorten_name('arkestra_clinical_trials_trial_funding_body')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('trial', models.ForeignKey(orm['arkestra_clinical_trials.trial'], null=False)),
            ('entity', models.ForeignKey(orm['contacts_and_people.entity'], null=False))
        ...
        # Adding M2M table for field sponsor on 'Trial'
        m2m_table_name = db.shorten_name('arkestra_clinical_trials_trial_sponsor')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('trial', models.ForeignKey(orm['arkestra_clinical_trials.trial'], null=False)),
            ('entity', models.ForeignKey(orm['contacts_and_people.entity'], null=False))
    ...
    def backwards(self, orm):
        # Adding model 'ClinicalTrialEntity'
        db.create_table('arkestra_clinical_trials_clinicaltrialentity', (
            ('clinical_trials_page_intro', self.gf('django.db.models.fields.related.ForeignKey')(related_name='clinical_trials_page_intro', null=True, to=orm['cms.Placeholder'])),
            ('menu_title', self.gf('django.db.models.fields.CharField')(default='Clinical trials', max_length=50)),
            ('publish_page', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('entity', self.gf('django.db.models.fields.related.OneToOneField')(related_name='clinical_trial_entity', unique=True, primary_key=True, to=orm['contacts_and_people.Entity'])),
        ))
        db.send_create_signal('arkestra_clinical_trials', ['ClinicalTrialEntity'])

        # Adding model 'ClinicalTrial'
        db.create_table('arkestra_clinical_trials_clinicaltrial', (
            ('status', self.gf('django.db.models.fields.CharField')(default='setup', max_length=25)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('grant_value', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('body', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True)),
            ('hosted_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='clinicaltrial_hosted_events', on_delete=models.SET_DEFAULT, default=None, to=orm['contacts_and_people.Entity'], blank=True, null=True)),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('importance', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True)),
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=60, unique=True, blank=True)),
            ('in_lists', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('short_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('summary', self.gf('django.db.models.fields.TextField')()),
            ('expanded_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('published', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('external_url', self.gf('django.db.models.fields.related.ForeignKey')(related_name='clinicaltrial_item', null=True, to=orm['links.ExternalLink'], on_delete=models.PROTECT, blank=True)),
        ))
        db.send_create_signal('arkestra_clinical_trials', ['ClinicalTrial'])

        # Adding M2M table for field funding_body on 'ClinicalTrial'
        m2m_table_name = db.shorten_name('arkestra_clinical_trials_clinicaltrial_funding_body')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('clinicaltrial', models.ForeignKey(orm['arkestra_clinical_trials.clinicaltrial'], null=False)),
            ('entity', models.ForeignKey(orm['contacts_and_people.entity'], null=False))
        ))
        db.create_unique(m2m_table_name, ['clinicaltrial_id', 'entity_id'])

        # Adding M2M table for field sponsor on 'ClinicalTrial'
        m2m_table_name = db.shorten_name('arkestra_clinical_trials_clinicaltrial_sponsor')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('clinicaltrial', models.ForeignKey(orm['arkestra_clinical_trials.clinicaltrial'], null=False)),
            ('entity', models.ForeignKey(orm['contacts_and_people.entity'], null=False))
        ...
        # Adding M2M table for field clinical_centre on 'ClinicalTrial'
        m2m_table_name = db.shorten_name('arkestra_clinical_trials_clinicaltrial_clinical_centre')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('clinicaltrial', models.ForeignKey(orm['arkestra_clinical_trials.clinicaltrial'], null=False)),
            ('entity', models.ForeignKey(orm['contacts_and_people.entity'], null=False))
        ...
        # Adding M2M table for field chief_investigators on 'ClinicalTrial'
        m2m_table_name = db.shorten_name('arkestra_clinical_trials_clinicaltrial_chief_investigators')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('clinicaltrial', models.ForeignKey(orm['arkestra_clinical_trials.clinicaltrial'], null=False)),
            ('person', models.ForeignKey(orm['contacts_and_people.person'], null=False))
        ))
        db.create_unique(m2m_table_name, ['clinicaltrial_id', 'person_id'])

        # Adding M2M table for field publish_to on 'ClinicalTrial'
        m2m_table_name = db.shorten_name('arkestra_clinical_trials_clinicaltrial_publish_to')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('clinicaltrial', models.ForeignKey(orm['arkestra_clinical_trials.clinicaltrial'], null=False)),
            ('entity', models.ForeignKey(orm['contacts_and_people.entity'], null=False))
        ...
        # Adding M2M table for field please_contact on 'ClinicalTrial'
        m2m_table_name = db.shorten_name('arkestra_clinical_trials_clinicaltrial_please_contact')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('clinicaltrial', models.ForeignKey(orm['arkestra_clinical_trials.clinicaltrial'], null=False)),
            ('person', models.ForeignKey(orm['contacts_and_people.person'], null=False))
        ...
        # Adding model 'ClinicalTrialType'
        db.create_table('arkestra_clinical_trials_clinicaltrialtype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('arkestra_clinical_trials', ['ClinicalTrialType'])

        # Deleting model 'TrialEntity'
        db.delete_table('arkestra_clinical_trials_trialentity')

        # Deleting model 'TrialType'
        db.delete_table('arkestra_clinical_trials_trialtype')

        # Deleting model 'Trial'
        db.delete_table('arkestra_clinical_trials_trial')

        # Removing M2M table for field publish_to on 'Trial'
        db.delete_table(db.shorten_name('arkestra_clinical_trials_trial_publish_to'))

        # Removing M2M table for field please_contact on 'Trial'
        db.delete_table(db.shorten_name('arkestra_clinical_trials_trial_please_contact'))

        # Removing M2M table for field trialtype on 'Trial'
        db.delete_table(db.shorten_name('arkestra_clinical_trials_trial_trialtype'))

        # Removing M2M table for field chief_investigators on 'Trial'
        db.delete_table(db.shorten_name('arkestra_clinical_trials_trial_chief_investigators'))

        # Removing M2M table for field clinical_centre on 'Trial'
        db.delete_table(db.shorten_name('arkestra_clinical_trials_trial_clinical_centre'))

        # Removing M2M table for field funding_body on 'Trial'
        db.delete_table(db.shorten_name('arkestra_clinical_trials_trial_funding_body'))

        # Removing M2M table for field sponsor on 'Trial'
        db.delete_table(db.shorten_name('arkestra_clinical_trials_trial_sponsor'))


    models = {
        'arkestra_clinical_trials.trial': {
            'Meta': {'object_name': 'Trial'},
            'body': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Placeholder']", 'null': 'True'}),
            'chief_investigators': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'trial_chief_investigators'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['contacts_and_people.Person']"}),
            'clinical_centre': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'trial_clinical_centres'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['contacts_and_people.Entity']"}),
            'date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'expanded_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'external_url': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'trial_item'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['links.ExternalLink']"}),
            'funding_body': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'trial_funding_bodies'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['contacts_and_people.Entity']"}),
            'grant_value': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'hosted_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'trial_hosted_events'", 'on_delete': 'models.SET_DEFAULT', 'default': 'None', 'to': "orm['contacts_and_people.Entity']", 'blank': 'True', 'null': 'True'}),
            ...
            'please_contact': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'trial_person'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['contacts_and_people.Person']"}),
            'publish_to': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'trial_publish_to'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['contacts_and_people.Entity']"}),
            ...
            'sponsor': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'trial_sponsors'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['contacts_and_people.Entity']"}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'setup'", 'max_length': '25'}),
            'summary': ('django.db.models.fields.TextField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'trialtype': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'trial_trialtype'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['arkestra_clinical_trials.TrialType']"}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        'arkestra_clinical_trials.trialentity': {
            'Meta': {'object_name': 'TrialEntity'},
        ...
        'arkestra_clinical_trials.trialtype': {
            'Meta': {'object_name': 'TrialType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
